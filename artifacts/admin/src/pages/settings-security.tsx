...
export function SecuritySection({ localValues, dirtyKeys, handleChange, handleToggle }: {
  ...
  const fetchLiveData = useCallback(async () => {
    ...
    try {
      ...
      console.error("[Security Settings] Failed to fetch security data:", error);
  ...
  const startMfaSetup = async () => {
    ...
    try {
      ...
      console.error("[Security Settings] MFA setup failed:", error);
      toast({ title: "Error", description: "Network error during MFA setup", variant: "destructive" });
    }
    setMfaLoading(false);
  };
  ...
  const verifyMfaToken = async () => {
    ...
    try {
      ...
      console.error("[Security Settings] MFA verification failed:", error);
      toast({ title: "Error", description: "Failed to verify MFA token", variant: "destructive" });
    }
    setMfaLoading(false);
  };
  ...
  const disableMfa = async () => {
    ...
    try {
      ...
      console.error("[Security Settings] MFA disable failed:", error);
