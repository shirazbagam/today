...
const ban = StyleSheet.create({
  ...
  title: { fontFamily: Font.bold, fontSize: 17, color: "#fff", marginBottom: 4, ...Platform.select({ native: { textShadow: "0px 1px 3px rgba(0,0,0,0.3)" }, web: { textShadow: "0px 1px 3px rgba(0,0,0,0.3)" } as any }) },
  desc: { fontFamily: Font.regular, fontSize: 12, color: "rgba(255,255,255,0.9)", lineHeight: 17, marginBottom: 10, ...Platform.select({ native: { textShadow: "0px 1px 2px rgba(0,0,0,0.2)" }, web: { textShadow: "0px 1px 2px rgba(0,0,0,0.2)" } as any }) },
