...
/* ── Configure CORS to properly handle proxied requests and cross-origin calls.
   In development (GitHub Codespaces), allow all origins since requests come through
   a proxy. In production, restrict to configured allowed origins.
   Preflight requests are crucial for complex CORS scenarios like redirects. ── */
app.use(cors({
  origin: true, // Allow all origins in development; Change to specific list in production
